...
| extraAcceptTypes     | `array`                 | no       | `[]`        | If allowing drop from outside the tree, the [drag type](https://react-dnd.github.io/react-dnd/docs/api/use-drag#specification-object-members) of the drag source.                                                                                                                                                                                                                                                                                                                                          |
...
| options.dragSourceId     | `number` \| `string` \| `undefined` | node id of the dragging source.<br>If the drag source is an element, file, etc. external to `DndProvider`, it will be `undefined`.                                                                                                                                                               |
...
| options.dragSource       | `object`                            | node item of the dragging source.<br>If the drag source is an element, file, etc. external to `DndProvider`, it will be `undefined`.                                                                                                                                                             |
